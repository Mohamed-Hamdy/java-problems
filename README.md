...
<details open="open">
  ...
  <ol>
    <li>
      <a href="#General">Multimedia Java Algorithms</a>
      <ul>
        <li><a href="#problem_1">Algorithm 1 LZ78 Algorithm</a></li>
      </ul>
      <ul>
        <li><a href="#problem_2">Algorithm 2 LZ88 Algorithm</a></li>
      </ul>
      <ul>
        <li><a href="#problem_3">Algorithm 3 LZW Algorithm</a></li>
      </ul>
      <ul>
        <li><a href="#problem_4">Algorithm 4 Adaptive Huffman Algorithm</a></li>
      </ul>
      <ul>
        <li><a href="#problem_5">Algorithm 5 Arithmetic Coding Floating Point Algorithm</a></li>
      </ul>
      <ul>
        <li><a href="#problem_6">Algorithm 6 StanderHuffman Algorithm</a></li>
      </ul>
      <ul>
        <li><a href="#problem_7">Algorithm 7 Vector Quantization Algorithm</a></li>
      </ul>
    </li>
    <li>
